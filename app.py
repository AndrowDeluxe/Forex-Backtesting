...
mt5_gold_silver_divergenz = st.Page(
    "app_pages/mt5_gold_silver_divergenz.py", title="Gold/Silber-Divergenz", icon=":material/compare_arrows:",
    visibility="hidden",
)
