"""Education -- persoenliche Lern-/Vorgehens-Seite, kein Backtest-Dashboard.

Aktuell ein einziger Track: eine Gold-Intraday-Strategie ausgehend von
SSRN-Papers aufbauen, mit derselben Disziplin wie der Rest des Repos
...
st.markdown("## :material/school: Education")
st.caption(
    "Persoenlicher Lern-/Vorgehens-Bereich -- keine Backtest-Ergebnisse, sondern "
    "Schritt-fuer-Schritt-Plaene, die wir gemeinsam abarbeiten."
)
