"""Optionale Telegram-Benachrichtigungen fuer den EK-Portfolio-Paper-Bot
(2026-08-27) - identisches Muster wie fk_instant_funding/telegram_notify.py:
Token/Chat-ID werden aus ek_portfolio/telegram_config.py gelesen, einer
...
try:
    from ek_portfolio.telegram_config import TELEGRAM_BOT_TOKEN, TELEGRAM_CHAT_ID
except ImportError:
