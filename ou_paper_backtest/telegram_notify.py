"""Optionale Telegram-Benachrichtigung fuer scanner.py (2026-09-02, Nutzerwunsch:
"3 Tagesscans als Telegram-Nachricht") -- identisches Muster wie
fk_instant_funding/telegram_notify.py: Token/Chat-ID werden aus
ou_paper_backtest/telegram_config.py gelesen, einer lokalen, in .gitignore
eingetragenen Datei (siehe telegram_config.example.py fuer die Vorlage). Ohne
diese Datei tut send_telegram_message() nichts - Telegram ist rein optional,
