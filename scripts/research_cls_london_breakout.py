"""Research script for the London-CLS-Fenster-Breakout (strategy/
cls_london_breakout.py) - full-period stats, IS/OOS split, per-year
breakdown, same discipline as every other strategy in this repo."""
...
def main():
    ...
    trades = simulate_london_cls_breakout(df)
